...
- `@v4` is a floating major tag. It is the compatibility channel for all non-breaking v4 updates.
- `@v4.0.0` is an exact release tag. It must stay fixed forever once published.
...
- Major tags in this repo are movable aliases (`v1`, `v2`, `v3`, `v4`).
- Exact release tags are SemVer tags such as `v4.0.0`.
