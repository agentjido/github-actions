...
uses: agentjido/github-actions/.github/workflows/jido-ci.yml@v5.2.5
```
...
- `@v5.2.5` is an exact release tag. It must stay fixed forever once published.
...
- README documents both the floating major form (`@v5`) and an exact version form (`@v5.2.5`).
